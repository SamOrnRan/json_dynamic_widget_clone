...
class JsonWidgetInternalBuildersBuilder {
  ...
  JsonWidgetInternalBuildersBuilder withCarousel() {
    builders[JsonCarouselSliderBuilder.type] = JsonWidgetBuilderContainer(
        builder: JsonCarouselSliderBuilder.fromDynamic,
        schemaId: CarouselSchema.id);
    return this;
  }

  JsonWidgetInternalBuildersBuilder withPdf() {
    builders[JsonPdfViewBuilder.type] = JsonWidgetBuilderContainer(
        builder: JsonPdfViewBuilder.fromDynamic, schemaId: PdfViewSchema.id);
    return this;
  }

  JsonWidgetInternalBuildersBuilder withWebView() {
    builders[JsonWebViewBuilder.type] = JsonWidgetBuilderContainer(
        builder: JsonWebViewBuilder.fromDynamic, schemaId: WebViewSchema.id);
    return this;
  }

  JsonWidgetInternalBuildersBuilder withHolderImage() {
    builders[JsonPlaceHolderImageBuilder.type] = JsonWidgetBuilderContainer(
        builder: JsonPlaceHolderImageBuilder.fromDynamic,
        schemaId: PlaceholderSchemaImage.id);
    return this;
  }

  JsonWidgetInternalBuildersBuilder withDisableIndecator() {
    builders[JsonDisableScrollIndecator.key] = JsonWidgetBuilderContainer(
