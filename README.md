...
To make sure that `BooleanStringArgProcessor` will be used the best is to add it as a first element of the list.# json_dynamic_widget_last
# json_dynamic_widget_last
